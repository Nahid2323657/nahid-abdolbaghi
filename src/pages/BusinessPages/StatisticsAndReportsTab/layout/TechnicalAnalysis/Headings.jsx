...
import HeadingTable from "./HeadingTabl";
    ...
    <>
      <div className="flex justify-between pt-5 px-5">
        <div className="flex justify-start items-center w-2/6 h-full">
          ...
          />
          <span className=" text-[#063468] text-sm pr-5">{content.lable}</span>
        </div>
        <div className=" flex-col w-3/6">
          <p className=" text-sm text-gray text-right">{content.value.tip}</p>
          <HeadingTable content={content} />
        </div>
